...
//  Odessa
//
//  Created by Alline Pedreira on 27/10/17.
...
public final class JoyStickView: UIView {
    ...
    private let baseImage = UIImage(named: "jSubstrate")!
    
    /// The image to use for the joystick handle
    private let handleImage = UIImage(named: "jStick")!
    ...
    private func initialize() {
        ...
        handleImageView.frame = bounds.insetBy(dx: 0.225 * bounds.width, dy: 0.225 * bounds.height)
    ...
    private func makeHandleImage() {
        ...
        handleImageView.image = UIImage(ciImage: inputImage!)
    }
